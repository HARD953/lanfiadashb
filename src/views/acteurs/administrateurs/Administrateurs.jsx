...
import DataTableCrudAdmin from '../../../components/Tables/Tables-crud/DataTableCrudAdmin';
  ...
  return (
    ...
    <CContainer>
      ...
      <CRow>
        ...
        <CCol xs={12}>
          <DataTableCrudAdmin acteursTitle="Administrateurs" detailUrl="/dashboard/details/acteursadmin" />
        </CCol>
